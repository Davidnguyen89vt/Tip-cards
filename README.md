...
1. Set your sheet CSV URL in:
   - `/Users/davidnguyen/Documents/Venmo Card/public/config.js`
...
```bash
cp "/Users/davidnguyen/Documents/Venmo Card/ops/com.david.tipcards.plist" "$HOME/Library/LaunchAgents/"
launchctl unload "$HOME/Library/LaunchAgents/com.david.tipcards.plist" 2>/dev/null || true
launchctl load "$HOME/Library/LaunchAgents/com.david.tipcards.plist"
```

Now the app auto-starts at login/startup and stays running.
Logs:
- `/Users/davidnguyen/Documents/Venmo Card/logs/tipcards.out.log`
- `/Users/davidnguyen/Documents/Venmo Card/logs/tipcards.err.log`
